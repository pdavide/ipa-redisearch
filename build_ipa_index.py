...
def build_ipa_index():
    ...
    ipa_index_amm = pd.read_csv(ipa_index_amm_url, sep='\t', dtype=str, on_bad_lines='warn')
    ...
    ipa_index_ou = pd.read_csv(ipa_index_ou_url, sep='\t', na_values=['da_indicare', 'da_indicare@x.it'], dtype=str, on_bad_lines='warn')
